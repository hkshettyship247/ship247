...
<section class="shadow-box small-box mt-8">
    <div class="dashboard-detail-box">
        ...
        <div class="profile-section mt-14">
            <form id="user-form" method="POST" action="{{ route('supplier.update.profile', $user->id) }}" class="default-form">
            @csrf
        ...
        <div class="security-section mt-14">
            ...
            <form id="user-form" method="POST" action="{{ route('supplier.password.update', $user->id) }}" class="default-form">
            @csrf
