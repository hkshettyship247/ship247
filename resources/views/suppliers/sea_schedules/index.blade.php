        ...
        <div class="dashboard-detail-box">
            <header>
                ...
                <div class="w-6/12 justify-end flex">
                    <a href="{{route('supplier.sea-schedules.create')}}" class="default-button-v2">
            ...
            <section class="search-result mt-8 mb-12">
                <form action="{{route('supplier.sea-schedules.index')}}" class="default-form">
                                ...
                                <div class="flex justify-end items-center h-full">
                                    ...
                                    <div id="dropdownSchedule-{{$seaSchedule->id}}"
                                        ...
                                        <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownScheduleButton">
                                            <li>
                                                <a href="{{route('supplier.sea-schedules.edit', [$seaSchedule->id])}}"
                                                   class="block px-4 py-2 hover:bg-red-600 hover:text-white">
                                                    <span>Edit Details</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{route('supplier.duplicate-price', [$seaSchedule->id])}}"
                                                   class="block px-4 py-2 hover:bg-red-600 hover:text-white">
                                                    <span>Duplicate</span>
                                                </a>
                                            </li>
                                            <li>
                                                <form
                                                    action="{{route('supplier.sea-schedules.destroy', [$seaSchedule->id])}}"
                                                    method="post">
                                                    @csrf
                                                    @method('delete')
    ...
    <div id="import-modal" tabindex="-1"
        ...
        <div class="relative w-full max-w-lg max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('supplier.sea-schedules.import') }}"
