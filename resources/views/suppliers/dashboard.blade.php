            ...
            {{-- <div class="4xl:w-3/12 lg:w-4/12 w-full">
                <div class="count-box">
                    ...
                    <div class="flex items-end justify-between">
                        ...
                        <a href="{{route('supplier.customers.index')}}" class="default-button red">
                            <span>view all</span>
                        </a>
                    </div>
                </div>
            ...
            <div class="4xl:w-3/12 lg:w-4/12 w-full">
                <div class="count-box">
                    ...
                    <div class="flex items-end justify-between">
                        ...
                        <a href="{{route('supplier.dashboard.index')}}" class="default-button red">
                            <span>view all</span>
                        </a>
                    </div>
                </div>
            ...
            <div class="4xl:w-3/12 lg:w-4/12 w-full">
                <div class="count-box">
                    ...
                    <div class="flex items-end justify-between">
                        ...
                        <a href="{{route('supplier.invoices.index')}}" class="default-button red">
                            <span>view all</span>
                        </a>
                    </div>
                </div>
    ...
    <div class="dashboard-detail-box">
        <header>
            ...
            <div class="md:w-6/12">
                ...
                <form class="dashboard-searchbar" action="{{ route('supplier.dashboard.index') }}" method="GET">
                ...
                <div class="detail-body">
                    @if(isset($bookings) && count($bookings)> 0)
                        @foreach ($bookings as $booking)
                            @include('suppliers.partials._booking-detail-box', ['booking' => $booking, 'tab' => 'all-tab'])
                        @endforeach
                    @else
                    ...
                    @if(isset($bookings) && count($bookings)> 0 && $inProgressBookingsCount > 0)
                        @foreach ($bookings as $booking)
                            @if(in_array($booking->status, [
                                ...
                                @include('suppliers.partials._booking-detail-box', ['booking' => $booking, 'tab' => 'inprogress-tab'])
                            @endif
                        @endforeach
                    @else
                        <div class="p-4 rounded-lg bg-gray-50">
                    ...
                    @if(isset($bookings) && count($bookings)> 0 && $completedBookingsCount > 0)
                        @foreach ($bookings as $booking)
                            @if($booking->status == config('constants.BOOKING_STATUS_COMPLETED') || $booking->status == config('constants.BOOKING_STATUS_FINISHED'))
                                @include('suppliers.partials._booking-detail-box', ['booking' => $booking, 'tab' => 'completed-tab'])
                            @endif
                        @endforeach
                    @else
                        <div class="p-4 rounded-lg bg-gray-50">
                    ...
                    @if(isset($bookings) && count($bookings)> 0 && $cancelledBookingsCount > 0)
                        @foreach ($bookings as $booking)
                            @if($booking->status == config('constants.BOOKING_STATUS_CANCELLED'))
                                @include('suppliers.partials._booking-detail-box', ['booking' => $booking, 'tab' => 'canceled-tab'])
                            @endif
                        @endforeach
                    @else
                        <div class="p-4 rounded-lg bg-gray-50">
                    ...
                    @if(isset($bookings) && count($bookings)> 0 && $onHoldBookingsCount > 0)
                        @foreach ($bookings as $booking)
                            @if($booking->status == config('constants.BOOKING_STATUS_ON_HOLD'))
                                @include('suppliers.partials._booking-detail-box', ['booking' => $booking, 'tab' => 'onhold-tab'])
                            @endif
                        @endforeach
                    @else
                        <div class="p-4 rounded-lg bg-gray-50">
