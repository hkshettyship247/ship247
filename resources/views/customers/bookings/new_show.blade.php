    ...
    <div class="dashboard-detail-box">
        ...
        <div class="step-progress">
            <ul id="progressbar">
                ...
                <li class="active"><span>SI SUBMITTED</span></li>
                <li><span>SI CONFIRMED</span></li>
                <li><span>EVGM SUBMITTED</span></li>
                <li><span>EVGM
                    CONFIRMED</span></li>
                <li><span>DRAFT BL RECEIVED</span></li>
                <li><span>DRAFT BL CONFIRMED</span></li>
                <li><span>FINISHED</span></li>
            </ul>
        </div>
