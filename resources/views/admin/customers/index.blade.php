...
@section('content')
    ...
    <section class="shadow-box mt-8">
        <div class="dashboard-detail-box">
                        ...
                        <div class="lg:w-3/12 w-full">
                            <div class="form-field">
                                ...
                                <input type="text" name="contact_number" id="contact_number"
                                       class="form-input small-input w-full" placeholder="Filter by Contact Number"
                        ...
                        <div class="detail-box relative lg:gap-0 gap-6 flex lg:flex-row flex-col">
                            ...
                            <div class="lg:w-3/12">
                                <div class="flex flex-col gap-4">
                                    <div>
                                        ...
                                        <span
                                            class="value">{{$customer->first_name . " " . $customer->last_name}}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="w-2/12">
                                <div class="flex justify-end items-center h-full">
                                    ...
                                    <button id="dropdownUserButton{{$customer->id}}"
                                            data-dropdown-toggle="dropdownUser{{$customer->id}}"
                                    ...
                                    <!-- Dropdown menu -->
                                    <div id="dropdownUser{{$customer->id}}"
                                         class="hidden z-10  bg-white divide-y divide-gray-100 rounded-lg shadow w-44 top-0 right-0">
                                        <ul class="py-2 text-sm text-gray-700"
                                            ...
                                            <li>
                                                <form
                                                    action="{{route('superadmin.customer.delete', ['customerID' => $customer->id])}}"
                                                    method="post">
                                                    @csrf
            ...
            <footer>
                <p class="number">Showing <strong>{{ $customers->firstItem() }} - {{ $customers->lastItem() }}</strong>
                </p>
                {{ $customers->links() }}
