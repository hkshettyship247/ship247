            ...
            <header>
                ...
                <section class="profile-section mt-14">
                       <div class="sec-title mb-4">
                          <span class="primary-color primary-font-medium block mt-2 view-personal-mode">BL 329910</span>
                       </div>
                            ...
                            <div class="2xl:w-6/12 xl:w-6/12 w-12/12">
                                <div class="grid xl:grid-cols-2 gap-6 mb-6">
                                    <div class="form-field">
                                        ...
                                        <span class="primary-color primary-font-medium block mt-2 view-personal-mode">{{ $payment_details->booking->created_at->format('d F Y') }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="2xl:w-6/12 xl:w-6/12 w-12/12">
                                <div class="grid xl:grid-cols-2 gap-6 mb-6">
                                    <div class="form-field">
                                        ...
                                        <span class="primary-color primary-font-medium block mt-2 view-personal-mode">15x20' Standard</span>
                                    </div>
                                </div>
                            </div>
                            <div class="2xl:w-6/12 xl:w-6/12 w-12/12">
                                <div class="grid xl:grid-cols-2 gap-6 mb-6">
                                    <div class="form-field">
                                        ...
                                        <span class="primary-color primary-font-medium block mt-2 view-personal-mode">Vegetables</span>
                                    </div>
                                </div>
                            </div>
                            <div class="2xl:w-6/12 xl:w-6/12 w-12/12">
                        ...
                        <div class="Tableflex mt-5">
                            <div class="form-field">
                                ...
                                <span class="primary-color primary-font-medium block mt-2 view-personal-mode">${{ $payment_details->booking->pickup_charges }}</span>
                            </div>
                            <div class="form-field">
                                <span class="uppercase text-gray-400 text-xs block">Origin Port Charges</span>
                                <span class="primary-color primary-font-medium block mt-2 view-personal-mode">${{ $payment_details->booking->origin_charges }}</span>
                            </div>
                            <div class="form-field">
                                <span class="uppercase text-gray-400 text-xs block">Destination Port Charges</span>
                                <span class="primary-color primary-font-medium block mt-2 view-personal-mode">${{ $payment_details->booking->destination_charges }}</span>
                            </div>
                            <div class="form-field">
                                <span class="uppercase text-gray-400 text-xs block">Freight Charges</span>
                                <span class="primary-color primary-font-medium block mt-2 view-personal-mode">${{ $payment_details->booking->basic_ocean_freight }}</span>
                            </div>
                            <div class="form-field">
                                <span class="uppercase text-gray-400 text-xs block">Delivery Charges</span>
                                <span class="primary-color primary-font-medium block mt-2 view-personal-mode">${{ $payment_details->booking->delivery_charges }}</span>
                            </div>
                        </div>
                        ...
                        <div class="back-btn">
                            <a href="{{ route('superadmin.bookings.show', $payment_details->booking->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg> <span>Back</span></a>
                        </div>
                </section>
