                    ...
                    <div class="grid grid-cols-1 gap-8 mt-6">
                        <div class="form-field">
                            ...
                            <select id="container_size" name="container_size" required
                                ...
                                <option value="{{ $container_size->value }}" @if($seaSchedule->container_size ==
                                    $container_size->value) selected @endif
                        ...
                        <div class="form-field">
                            ...
                            <label class="form-field checkbox-field mt-2">
                                <input type="checkbox" name="origin_charges_included" id="origin_charges_included"
                                    value="1" class="form-checkbox" @if($seaSchedule->origin_charges_included === 1)
                                checked @endif>
                        ...
                        <div class="form-field">
                            ...
                            <label class="form-field checkbox-field mt-2">
                                <input type="checkbox" name="destination_charges_included"
                                    id="destination_charges_included" value="1" class="form-checkbox"
                    ...
                    <div class="grid grid-cols-1 gap-8 mt-6">
                        <div class="form-field">
                            ...
                            <select id="company_id" name="company_id" required
                                ...
                                <option value="{{ $company_id }}" @if($seaSchedule->company_id == $company_id) selected
                                    @endif
                                    >{{$company_name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="grid grid-cols-2 gap-8 mt-6">
                        ...
                        <div class="form-field">
                            ...
                            <input type="number" id="tt" name="tt" required
                                class="form-input small-input mt-2 w-full block" value="{{ $detail->tt }}">
                            @error('tt')
                            <span>{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-field">
                            ...
                            <input type="number" id="ft" name="ft" required
                                class="form-input small-input mt-2 w-full block" value="{{ $detail->ft }}">
                            @error('ft')
                            <span>{{ $message }}</span>
                            @enderror
                        </div>
