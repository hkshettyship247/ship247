    ...
    <div class="dashboard-detail-box">
        <header>
            ...
            <div class="w-3/12 justify-end flex">
                <a href="{{route('employee.locations.create')}}" class="default-button-v2">
        ...
        <section class="search-result mt-8 mb-12">
            ...
            <form class="default-form" action="{{ route('employee.locations.index') }}" method="GET">
                    ...
                    <div class="flex justify-end items-center h-full">
                        ...
                        <div id="dropdownLocation-{{$location->id}}"
                            ...
                            <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownLocationButton">
                                {{-- <li>
                                    <a href="{{route('employee.locations.edit', $location->id)}}" class="block px-4 py-2 hover:bg-red-600 hover:text-white">
                                        <span>Edit</span>
                                    </a>
                                </li> --}}
                                <li>
                                    <form action="{{route('employee.locations.destroy', $location->id)}}" method="post">
                                        @csrf
                                        @method('delete')
