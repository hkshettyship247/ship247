    ...
    <div class="dashboard-detail-box">
        <header>
            ...
            <div class="md:w-6/12 md:justify-end flex">
                <a href="{{route('employee.news.create')}}" class="default-button-v2">
                    <span>Add News</span>
                </a>
            </div>
        </header>
        ...
        <section class="search-result mt-8 mb-12">
            ...
            <form class="default-form" action="{{ route('employee.news.index') }}" method="GET">
                    ...
                    <div class="flex lg:justify-end items-start h-full">
                        ...
                        <div id="dropdownInvoice-{{$news->id}}"
                            ...
                            <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownInvoiceButton">
                                <li>
                                    <a href="{{route('employee.news.edit', ['news' => $news->id])}}" class="block px-4 py-2 hover:bg-red-600 hover:text-white">
                                        <span>Edit</span>
                                    </a>
                                </li>
                                <li>
                                    <form action="{{route('employee.news.destroy', ["news" =>$news->id])}}" method="POST">
                                        @csrf
                                        @method('DELETE')
