        ...
        <div class="dashboard-detail-box">
            <header>
                ...
                <div class="w-6/12 justify-end flex">
                    <a href="{{route('employee.land-schedules.create')}}" class="default-button-v2">
            ...
            <section class="search-result mt-8 mb-12">
                <form action="{{route('employee.land-schedules.index')}}" class="default-form">
                            ...
                            <div class="flex gap-4">
                                <div class="w-6/12">
                                    <div class="form-field">
                                        ...
                                        @include('employees.partials._location-select2',
                                            [
                                                'name' => 'origin_id',
                                ...
                                <div class="flex justify-end items-center h-full">
                                    ...
                                    <div id="dropdownSchedule-{{$landSchedule->id}}"
                                        ...
                                        <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownScheduleButton">
                                            <li>
                                                <a href="{{route('employee.land-schedules.edit', [$landSchedule->id])}}"
                                            ...
                                            <li>
                                                <form
                                                    action="{{route('employee.land-schedules.destroy', [$landSchedule->id])}}"
                                                    method="post">
                                                    @csrf
                                                    @method('delete')
    ...
    <div id="import-modal" tabindex="-1"
        ...
        <div class="relative w-full max-w-lg max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('employee.land-schedules.import') }}"
