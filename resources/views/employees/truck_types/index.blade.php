        ...
        <div class="dashboard-detail-box">
            <header>
                ...
                <div class="w-3/12 justify-end flex">
                    <a href="{{route('employee.truck-types.create')}}" class="default-button-v2">
                                ...
                                <div class="flex justify-end items-start h-full">
                                    ...
                                    <div id="dropdownInvoice-{{$truck_type->id}}"
                                        ...
                                        <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownInvoiceButton">
                                            <li>
                                                <a href="{{route('employee.truck-types.edit', ['truckType' => $truck_type->id])}}"
                                            ...
                                            <li>
                                                <form
                                                    action="{{route('employee.truck-types.destroy', ["truckType" => $truck_type->id])}}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
