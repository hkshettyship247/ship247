        ...
        <div class="dashboard-detail-box">
            <header>
                ...
                <div class="md:w-6/12 md:justify-end flex">
					...
					<a href="{{route('employee.work-with-us-form-detail', ['workWithUsFormID' => $work_with_us_form_detail->id ])}}" class="default-button-v2">
						<span>Form</span>
					</a>
					@endif
                ...
                @if(isset($company_details))
					...
					@else
						<div class="md:w-6/12 flex">
							@if($company_details->status == config('constants.COMPANY_REGISTRATION_STATUS_APPROVED'))
								<a href="{{route('employee.companyStatus.deactivate',$company_details->id )}}" class="default-button-v2">
									<span>De-activate</span>
								</a>
								<a href="{{route('employee.companyStatus.terminate',$company_details->id )}}" class="default-button-v2 outline-button">
									<span>Terminate</span>
								</a>
							@else
								<a href="{{route('employee.companyStatus.reactivate',$company_details->id )}}" class="default-button-v2 outline-button">
