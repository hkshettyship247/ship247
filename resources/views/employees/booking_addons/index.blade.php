    ...
    <section class="shadow-box mt-8">
        <div class="dashboard-detail-box">
            <header>
                ...
                <div>
                    <a href="{{route('employee.'.request()->route_type_addition.'-booking-addons.create')}}" class="default-button-v2">
                                ...
                                <div class="flex justify-end items-center h-full">
                                    ...
                                    <div id="dropdownAddons{{$booking_addon->id}}"
                                        ...
                                        <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownAddonsButton">
                                            <li>
                                                <a href="{{route('employee.'.request()->route_type_addition.'-booking-addons.edit', ["booking_addon" =>$booking_addon->id])}}"
                                                   class="block px-4 py-2 hover:bg-red-600 hover:text-white">
                                                    <span>Edit</span>
                                                </a>
                                            </li>
                                            <li>
                                                <form action="{{ route('employee.'.request()->route_type_addition.'-booking-addons.destroy',
