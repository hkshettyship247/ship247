    ...
    <div class="dashboard-detail-box">
        <header>
            ...
            <div class="w-3/12 justify-end flex">
                <a href="{{route('employee.'.request()->route_type_addition.'-hot-deals.create')}}" class="default-button-v2">
                    ...
                    <div class="flex justify-end items-start h-full">
                        ...
                        <div id="hotDeal-{{$hot_deal->id}}"
                            ...
                            <ul class="py-2 text-sm text-gray-700" aria-labelledby="hotDealButton">
                                <li>
                                    <a href="{{route('employee.'.request()->route_type_addition.'-hot-deals.edit', ['hot_deal' => $hot_deal->id])}}" class="block px-4 py-2 hover:bg-red-600 hover:text-white">
                                        <span>Edit</span>
                                    </a>
                                </li>
                                <li>
                                    <form action="{{route('employee.'.request()->route_type_addition.'-hot-deals.destroy', ["hot_deal" =>$hot_deal->id])}}" method="POST">
                                        @csrf
                                        @method('DELETE')
