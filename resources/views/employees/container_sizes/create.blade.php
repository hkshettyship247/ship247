    ...
    <section class="shadow-box mt-8">
        <div class="dashboard-detail-box">
            <header>
                ...
                <div>
                    <a href="{{route('employee.container-sizes.index')}}" class="default-button-v2 outline-button">
                        <span>Back</span>
                    </a>
                </div>
            </header>
            ...
            <div class="detail-body">
                <div class="md:w-6/12">
                    <form method="POST" action="{{ route('employee.container-sizes.store') }}" class="default-form">
                        @csrf
                        <div class="grid grid-cols-1 gap-8 mt-6">
                            ...
                            <div class="form-field">
                                ...
                                <input type="text" id="value" name="value"
                                       class="form-input small-input mt-2 w-full block" value="{{ old('value') }}">
                                @error('value')
                                    <span>{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-field">
                                ...
                                <input type="text" id="cma_value" name="cma_value"
                                       class="form-input small-input mt-2 w-full block" value="{{ old('cma_value') }}">
                                @error('cma_value')
                                <span>{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-field">
                                ...
                                <input type="text" id="hapag_value" name="hapag_value"
                                       class="form-input small-input mt-2 w-full block" value="{{ old('hapag_value') }}">
                                @error('hapag_value')
                                <span>{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-field">
                                ...
                                <input type="text" id="msc_value" name="msc_value"
                                       class="form-input small-input mt-2 w-full block" value="{{ old('msc_value') }}">
                                @error('msc_value')
                                <span>{{ $message }}</span>
                                @enderror
                            </div>
