        ...
        <div class="dashboard-detail-box">
            <header>
                ...
                <div class="w-6/12 justify-end flex">
                    <a href="{{route('employee.container-sizes.create')}}" class="default-button-v2">
                                ...
                                <div class="flex justify-end items-start h-full">
                                    ...
                                    <div id="dropdownInvoice-{{$container_size->id}}"
                                        ...
                                        <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownInvoiceButton">
                                            <li>
                                                <a href="{{route('employee.container-sizes.edit', ['containerSize' => $container_size->id])}}"
                                            ...
                                            <li>
                                                <form
                                                    action="{{route('employee.container-sizes.destroy', ["containerSize" => $container_size->id])}}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
