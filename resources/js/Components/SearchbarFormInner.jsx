    ...
    const mapCityList = (data) => {
        return data.map((loc) => {
			...
			if(loc.is_port == 1){
				...
				return { UNLocCode: loc.code, value: loc.fullname, isPort: loc.is_port,
        ...
        >
            <div className="search-form mt-4">
                ...
                <div className="lg:w-3/12 w-full">
                    ...
                    >
                        <AutoComplete
                            ...
                            onSelect={(value, selectedOption) =>
                                setOrigin2(selectedOption.UNLocCode, selectedOption.isPort, selectedOption.value, cityLogo, portLogo)
                            }
                            onSearch={(text) => {
					...
					<img src={pcLogoOrigin} alt={messageOrigin} className="searchBarImage1" width={widthOrigin} height={heightOrigin} />
				 </div>
                </div>
                ...
                <div className="lg:w-3/12 w-full">
                        ...
                        >
                            <AutoComplete
                                ...
                                onSelect={(value, selectedOption) =>
                                    setDestination2(selectedOption.UNLocCode, selectedOption.isPort, selectedOption.value, cityLogo, portLogo)
                                }
                                onSearch={(text) => {
						...
						<img src={pcLogoDestination} alt={messageDestination} className="searchBarImage2" width={widthDestination} height={heightDestination} />
                     </div>
                </div>
